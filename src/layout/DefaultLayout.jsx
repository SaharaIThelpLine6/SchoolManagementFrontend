...
const menuData = [
  ...
  // Student Menu bar Start
  {
    ...
    subMenu: [
      ...
      },
      {
        ...
        route: "/sessions",
        subMenu: false,
        icon: `<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-id-badge"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 3m0 3a3 3 0 0 1 3 -3h8a3 3 0 0 1 3 3v12a3 3 0 0 1 -3 3h-8a3 3 0 0 1 -3 -3z" /><path d="M12 13m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M10 6h4" /><path d="M9 18h6" /></svg>`
      },
      // {
      //   id: "6",
      //   name: "Certificate",
  ...
  // Student Menu bar End
  // Staff Menu bar Start
  {
    id: "3",
    name: "Employee",
    route: "/teacherinfo",
    ...
    subMenu: [
      {
        ...
        name: "Teacher Info",
        route: "/teacherInfo",
        icon: `<img src='/teacher.svg' alt="Teacher" class="w-7 h-7" />`,
        subMenu: false
      },
      {
        id: "2",
  ...
  // Staff Menu bar End
  {
    ...
    name: "Account",
    route: "/accounts",
    icon: `<svg fill="#ffffff" width="40px" height="40px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
  ...
  return (
    <div className="block">
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        {/* <aside className={`absolute left-0 top-0 h-screen w-[18.125rem] bg-white z-10`}>
          aside
        </aside> */}
        {/* <Sidebar/> */}
        ...
        {/* <!-- ===== Content Area Start ===== --> */}
        <div className="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden show_in_print">
          {/* <!-- ===== Header Start ===== --> */}
          <Header />
          {/* <Filter /> */}
          {/* <!-- ===== Header End ===== --> */}
          ...
          <main className='pt-[24px] border-t border-[#eee] show_in_print'>
            <div >
              <Outlet />
            </div>
