    ...
    <div className="font-default bg-gray-50 min-h-screen pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-sm p-6 text-white">
          <p className="text-blue-100 text-sm mb-1">{translate("গত ১ মাসে সাপোর্ট দেওয়া হয়েছে")}</p>
          <h3 className="text-4xl font-bold">{loading ? "..." : dashboardData.totalSupportLastMonth} {translate("টি")}</h3>
        ...
        <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl shadow-sm p-6 text-white">
          ...
          <h3 className="text-4xl font-bold">{loading ? "..." : dashboardData.active} {translate("টি")}</h3>
        </div>
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-sm p-6 text-white">
          ...
          <h3 className="text-4xl font-bold">{loading ? "..." : dashboardData.quotaSold} {translate("টি")}</h3>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <div className="p-4 border-b border-gray-100">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={activeSupportTab === "team" ? translate("নাম দিয়ে সার্চ করুন...") : translate("মাদ্রাসার নাম দিয়ে সার্চ করুন...")}
            ...
            <div className="overflow-y-auto flex-1 p-2">
              {supportListLoading ? (
                <div className="text-center text-gray-500 py-8 text-sm">{translate("লোড হচ্ছে...")}</div>
              ) : filteredSupportList.length === 0 ? (
                <div className="text-center text-gray-500 py-8 text-sm">{translate("কোনো তথ্য পাওয়া যায়নি")}</div>
              ) : (
                  ...
                  {filteredSupportList.map((item, index) => (
                    ...
                    >
                      ...
                      <span className="text-xs font-semibold bg-blue-50 text-blue-700 px-2 py-1 rounded-full">
                        {item.supportCount} {translate("টি")}
                      </span>
                    </li>
                  ))}
                </ul>
            ...
            {!supportListLoading && supportPagination[activeSupportTab].totalPages > 1 && (
              <div className="p-3 border-t border-gray-200 flex items-center justify-between">
                <div className="text-sm text-gray-600">
                  {translate("মোট")} {supportPagination[activeSupportTab].total} {translate("টি ফলাফল")}
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700">
                    {translate("পৃষ্ঠা")} {supportPagination[activeSupportTab].page} / {supportPagination[activeSupportTab].totalPages}
                  </span>
                  <button
      ...
      {/* 🔥 হিটম্যাপ — ডাইনামিক */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-800 mb-4">{translate("অভিযোগের সময়সীমা (প্রতি ৭ দিন - ২৪ ঘণ্টা)")}</h2>
        <div className="overflow-x-auto">
          <div className="min-w-[800px]">
            {heatmapLoading ? (
              <div className="flex items-center justify-center h-64 text-gray-500">{translate("লোড হচ্ছে...")}</div>
            ) : (
            ...
            <div className="flex justify-end items-center gap-2 mt-4 text-xs text-gray-500">
              ...
              <span>{translate("বেশি অভিযোগ")}</span>
            </div>
          </div>
        </div>
      </div>
...
//   const renewData = [
//     { name: "নবায়ন করেছেন", value: Number(dashboardData.active) || 0 }, 
//     { name: "নবায়ন করেননি", value: Number(dashboardData.inactive) || 0 },
//   ];

//   const quotaData = [
//     { name: "ব্যবহার হচ্ছে", value: Number(dashboardData.quotaSold) || 0 }, 
//     { name: "অব্যবহৃত", value: Number(dashboardData.quotaUnused) || 0 },
//   ];

//   const activeInactiveData = [
//     { name: "সক্রিয়", value: Number(dashboardData.active) || 0 }, 
//     { name: "নিষ্ক্রিয়", value: Number(dashboardData.inactive) || 0 },
//   ];

//   const loginData = [
//     { name: "লগইন করেছে", value: Number(dashboardData.online) || 0 }, 
//     { name: "লগইন করেনি", value: Number(dashboardData.offline) || 0 },
//   ];

//   // 🌟 অভিযোগের ক্যাটাগরি — এখন InventoryNode.Status থেকে (আগে mock data ছিল)
//   const complaintCategoryData = [
//     { name: "আগ্রহী", count: Number(dashboardData.complaintCategory?.interested) || 0 },
//     { name: "রিসিভ করে না", count: Number(dashboardData.complaintCategory?.notReceiving) || 0 },
//     { name: "অভিযোগ করেছে", count: Number(dashboardData.complaintCategory?.complained) || 0 },
//     { name: "অনাগ্রহী", count: Number(dashboardData.complaintCategory?.notInterested) || 0 },
//   ];

//   const complaintSeries = [{ name: "অভিযোগ", data: complaintCategoryData.map((item) => item.count) }];
//   const complaintOptions = {
//     chart: { type: "bar", toolbar: { show: false }, fontFamily: "inherit" },
//     colors: ["#f59e0b"],
//     plotOptions: { bar: { horizontal: true, borderRadius: 4, barHeight: "50%" } },
...
//             name: { show: true, fontSize: "12px" },
//             value: { show: true, fontSize: "16px", fontWeight: "bold" },
//             total: { show: true, label: "মোট", fontSize: "14px", color: "#373d3f" }
//           }
//         } 
//       } 
//     },
...
//       <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6 sticky top-0 z-30">
//         <div className="flex flex-col md:flex-row items-end md:items-center justify-between gap-4">
//           <h2 className="text-lg font-semibold text-gray-800 flex-shrink-0">ফিল্টার করুন:</h2>
//           <div className="flex flex-wrap gap-4 w-full md:w-auto items-center">
...
//                 className="flex items-center justify-between min-w-[220px] bg-white border border-gray-300 hover:border-gray-400 text-gray-700 py-2 px-3 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500"
//               >
//                 <span className="text-gray-500 font-normal mr-2">Custom</span>
//                 {getDisplayDateRange()}
//                 <svg className="w-4 h-4 ml-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
//                 </svg>
...
//                     <div className="flex flex-col gap-3 mb-4">
//                       <div className="w-full">
//                         <label className="block text-xs text-blue-600 font-semibold mb-1">Start date</label>
//                         <input
//                           type="date"
//                           value={tempStart}
//                           onChange={(e) => { setTempStart(e.target.value); setActivePreset("Custom"); }}
...
//                       </div>
//                       <div className="w-full">
//                         <label className="block text-xs text-gray-600 font-medium mb-1">End date</label>
//                         <input
//                           type="date"
//                           value={tempEnd}
//                           onChange={(e) => { setTempEnd(e.target.value); setActivePreset("Custom"); }}
...
//                         Reset
//                       </button>
//                       <button onClick={() => setIsDatePickerOpen(false)} className="px-3 py-1.5 text-xs font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-md transition-colors">Cancel</button>
//                       <button onClick={applyDateRange} className="px-3 py-1.5 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md shadow-sm transition-colors">Apply</button>
//                     </div>
//                   </div>
//                 </div>
//               )}
...
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
//         <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-sm p-6 text-white">
//           <p className="text-blue-100 text-sm mb-1">গত ১ মাসে সাপোর্ট দেওয়া হয়েছে</p>
//           <h3 className="text-4xl font-bold">{loading ? "..." : dashboardData.totalSupportLastMonth} টি</h3>
//           <p className="text-xs mt-2 bg-blue-400/30 inline-flex items-center gap-1 px-2 py-1 rounded">
...
//         </div>
//         <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl shadow-sm p-6 text-white">
//           <p className="text-emerald-100 text-sm mb-1">সর্বমোট সক্রিয় মাদ্রাসা</p>
//           <h3 className="text-4xl font-bold">{loading ? "..." : dashboardData.active} টি</h3>
//         </div>
//         <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-sm p-6 text-white">
//           <p className="text-purple-100 text-sm mb-1">মোট বিক্রি হওয়া কোটা</p>
//           <h3 className="text-4xl font-bold">{loading ? "..." : dashboardData.quotaSold} টি</h3>
//         </div>
//       </div>
...
//       <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
//         <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
//           <h2 className="text-lg font-semibold text-gray-800 mb-4">অভিযোগের ক্যাটাগরি (গত ১ মাস)</h2>
//           <div className="h-64">
//             {loading ? (
//               <div className="flex items-center justify-center h-full text-gray-500">লোড হচ্ছে...</div>
//             ) : (
//               <ReactApexChart options={complaintOptions} series={complaintSeries} type="bar" height="100%" width="100%" />
//             )}
//           </div>
...
//         <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
//           <h2 className="text-lg font-semibold text-gray-800 mb-4">নতুন মাদ্রাসা (গত ১২ মাস)</h2>
//           <div className="h-64">
//             {loading ? (
//               <div className="flex items-center justify-center h-full text-gray-500">লোড হচ্ছে...</div>
//             ) : (
...
//         <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center">
//           <h2 className="text-md font-semibold text-gray-800 mb-2 text-center">নবায়ন স্ট্যাটাস (গত ১২ মাস)</h2>
//           <div className="h-48 w-full">
//             <ReactApexChart
//               options={createPieOptions(renewData, 0)}
//               series={renewData.map(i => i.value)}
...
//         <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center">
//           <h2 className="text-md font-semibold text-gray-800 mb-2 text-center">কোটা স্ট্যাটাস (গত ১২ মাস)</h2>
//           <div className="h-48 w-full">
//             <ReactApexChart
//               options={createPieOptions(quotaData, 2)}
//               series={quotaData.map(i => i.value)}
...
//         <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center">
//           <h2 className="text-md font-semibold text-gray-800 mb-2 text-center">মাদ্রাসা স্ট্যাটাস (গত ১২ মাস)</h2>
//           <div className="h-48 w-full">
//             <ReactApexChart
//               options={createPieOptions(activeInactiveData, 0)}
//               series={activeInactiveData.map(i => i.value)}
...
//         <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center">
//           <h2 className="text-md font-semibold text-gray-800 mb-2 text-center">লগইন স্ট্যাটাস (গত ১ মাস)</h2>
//           <div className="h-48 w-full">
//             <ReactApexChart
//               options={createPieOptions(loginData, 3)}
//               series={loginData.map(i => i.value)}
...
//           >
//             <div className="flex items-center justify-between p-4 border-b border-gray-200">
//               <h3 className="text-lg font-semibold text-gray-800">সাপোর্ট লিস্ট (গত ১ মাস)</h3>
//               <button onClick={() => setIsSupportListOpen(false)} className="text-gray-400 hover:text-gray-600">
//                 <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
//                 </svg>
...
//                   value={supportSearchQuery}
//                   onChange={(e) => setSupportSearchQuery(e.target.value)}
//                   placeholder={activeSupportTab === "team" ? "নাম দিয়ে সার্চ করুন..." : "মাদ্রাসার নাম দিয়ে সার্চ করুন..."}
//                   className="w-full border border-gray-300 rounded-md py-2 pl-9 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
//                 />
//               </div>
//             </div>
...
//             <div className="overflow-y-auto flex-1 p-2">
//               {supportListLoading ? (
//                 <div className="text-center text-gray-500 py-8 text-sm">লোড হচ্ছে...</div>
//               ) : filteredSupportList.length === 0 ? (
//                 <div className="text-center text-gray-500 py-8 text-sm">কোনো তথ্য পাওয়া যায়নি</div>
//               ) : (
//                 <ul className="divide-y divide-gray-100">
//                   {filteredSupportList.map((item, index) => (
//                     <li
...
//               <div className="p-3 border-t border-gray-200 flex items-center justify-between">
//                 <div className="text-sm text-gray-600">
//                   মোট {supportPagination[activeSupportTab].total} টি ফলাফল
//                 </div>
//                 <div className="flex items-center gap-2">
//                   <button
//                     disabled={supportPagination[activeSupportTab].page <= 1}
...
//                   </button>
//                   <span className="text-sm text-gray-700">
//                     পৃষ্ঠা {supportPagination[activeSupportTab].page} / {supportPagination[activeSupportTab].totalPages}
//                   </span>
//                   <button
//                     disabled={supportPagination[activeSupportTab].page >= supportPagination[activeSupportTab].totalPages}
//                     onClick={() => handleSupportPageChange(supportPagination[activeSupportTab].page + 1)}
...
//       {/* 🔥 হিটম্যাপ — ডাইনামিক */}
//       <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
//         <h2 className="text-lg font-semibold text-gray-800 mb-4">অভিযোগের সময়সীমা (প্রতি ৭ দিন - ২৪ ঘণ্টা)</h2>
//         <div className="overflow-x-auto">
//           <div className="min-w-[800px]">
//             {heatmapLoading ? (
//               <div className="flex items-center justify-center h-64 text-gray-500">লোড হচ্ছে...</div>
//             ) : (
//               <ReactApexChart options={heatmapOptions} series={heatmapSeries} type="heatmap" height={350} width="100%" />
//             )}
//             <div className="flex justify-end items-center gap-2 mt-4 text-xs text-gray-500">
