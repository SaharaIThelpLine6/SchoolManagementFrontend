...
// ✅ ফিক্সড লোগো
const DEFAULT_LOGO = "/saharaITnewlogo.svg";
...
const AdminHeader = () => {
  ...
  // এই useEffect আর কার্যকর হবে না, কারণ আমরা এখন ফিক্সড লোগো ব্যবহার করছি
  useEffect(() => {
      ...
      <div className="flex items-center justify-between px-4 py-2 sm:py-3 md:px-6 2xl:px-11 sm:hidden">
        ...
        <div className="ml-16 sm:ml-0">
          <img
            src={DEFAULT_LOGO}
            alt="Logo"
            className="w-32 h-8 object-contain"  // ✅ আয়তাকার লোগো
          />
        </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link to={"/general-info/institution-info"}>
              <img
                src={DEFAULT_LOGO}
                alt="Logo"
                className="w-40 h-10 object-contain"  // ✅ আয়তাকার লোগো
              />
            </Link>
          </div>
        </div>
