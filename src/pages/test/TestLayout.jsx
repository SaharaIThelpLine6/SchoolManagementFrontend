...
const TestLayout = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-100 font-SolaimanLipi overflow-hidden print:h-auto print:bg-white">
      {/* Header */}
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <main className="flex-1 ml-0 h-full overflow-y-auto">
          <div className="p-1 md:p-4 lg:p-4 bg-[#F2F3F3] min-h-full print:p-0 print:h-auto print:bg-white print:min-h-auto">
            <div>
              <Outlet />
            </div>
