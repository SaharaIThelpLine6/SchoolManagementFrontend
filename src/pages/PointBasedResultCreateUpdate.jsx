...
const PointBasedResultCreateUpdate = ({ pageTitle }) => {
  ...
  const onSubmit = async (data) => {
    ...
    const studentResults = students
      .filter((student) => {
        if (startID && startID > student.UserCode) return false;
        if (endID && endID < student.UserCode) return false;
        return true;
      })
      .map((student) => {
        ...
        const subjectsWithValues = student.Subjects.map(
          (subjectName, index) => {
...
//     const visibleSubjectCount =
//       paginatedData[0]?.allSubjects?.filter((subject) =>
//         effectiveSubject ? subject.SubjectName === effectiveSubject : true
//       ).length ?? 0;
...
//   // =========================
//   const filteredSubjects = (paginatedData[0]?.Subjects || []).filter(
//     (subject) => (effectiveSubject ? subject === effectiveSubject : true)
//   );
...
//                       (subject) =>
//                         effectiveSubject
//                           ? subject.SubjectName === effectiveSubject
//                           : true
//                     );
...
// //   // =========================
// //   // Teacher এর SubjectID list
// //   // =========================
// //   const teacherSubjectIds = useMemo(() => {
// //     const list = Array.isArray(teacherSubjects?.data)
// //       ? teacherSubjects.data
// //       : Array.isArray(teacherSubjects)
// //         ? teacherSubjects
// //         : [];

// //     return list.map((t) => Number(t.SubjectID));
// //   }, [teacherSubjects]);

// //   // =========================
// //   // Student এর subject filter
// //   // =========================
// //   const filteredStudentSubjects = useMemo(() => {
// //     if (!Array.isArray(students) || students.length === 0) return [];
...
// //     // Teacher এর subject names বের করুন
// //     const rawTeachers = Array.isArray(teacherSubjects?.data)
// //       ? teacherSubjects.data
// //       : Array.isArray(teacherSubjects)
// //         ? teacherSubjects
...
// //     const teacherSubjectNames = rawTeachers
// //       .map((t) => t.SubjectName)
// //       .filter(Boolean);
