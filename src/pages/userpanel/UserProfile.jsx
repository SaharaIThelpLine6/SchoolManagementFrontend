    ...
    return (
        <div className="bg-white shadow-xl pb-8 relative h-screen">
            ...
            <div className="flex flex-col items-center -mt-20">
                ...
                <p className="text-gray-700">{userDetails?.User.permanentPost}, {userDetails?.User.permanentVill}</p>
                    ...
                    <div className="flex-1 bg-white rounded-lg p-4 pt-2">
                        ...
                        <ul className="mt-2 text-gray-700">
                            <li className="flex border-b py-2">
                                ...
                                <span className="text-gray-700">{userDetails?.User.FatherName}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">বর্তমান ক্লাস:</span>
                                <span className="text-gray-700">{userDetails?.Class.ClassName}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">মোবাইল:</span>
                                <span className="text-gray-700">{userDetails?.User.Mobile1}</span>
                            </li>
                            <li className="flex border-b py-2">
                            ...
                            <li className="flex border-b py-2">
                                ...
                                <span className="text-gray-700">{userDetails?.User.DateOfBirth}</span>
                            </li>
                            <li className="flex border-b py-2">
                                <span className="font-bold w-24">স্টেটাস:</span>
                                <span className="text-gray-700">{userDetails?.User.UserAction == 1 ? 'Active' : "Inactive"}</span>
                            </li>
                            {/* <li className="flex border-b py-2">
