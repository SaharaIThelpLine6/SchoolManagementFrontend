        ...
        <div className="shadow-[0_0_10px_rgba(0,0,0,0.25)] py-5 px-4 rounded-[10px] ">
          <div className="flex items-center justify-between">
            <div className="flex gap-[20px] items-center notice_header_area">
              ...
              <div className="text-[20px]">সর্বশেষ রির্পোট</div>
            </div>
            <div>
              <a
                href={`/${schoolid}/dashboard/user_reports`}
                className="text-sky-600 text-[14px]"
              >
                সব দেখুন
              </a>
            </div>
          ...
          {userReports && userReports.length > 0 ? (
            <div className="notice_area mt-4 py-4 px-3 bg-yellow-50 relative rounded-[10px] after:content-[''] after:w-[5px] after:h-full after:absolute after:top-0 after:left-0 after:bg-white after:bg-yellow-300">
              <div className="flex justify-between">
                <h2 className="text-[16px]">
                  {userReports?.[0]['ReportCet']['ReportCetName']}
                </h2>
                <p className="py-1 px-2 rounded-full bg-yellow-500 text-white text-[13px]">
                  {userReports?.[0]['CreateDate']}
                </p>
              </div>
              <p className="mt-4">{userReports?.[0]['Remark']}</p>
            </div>
          ) : null}
        </div>
