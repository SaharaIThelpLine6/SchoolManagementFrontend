    ...
    <main className="mian_area pt-4 pb-[100px]">
      <div className="container mx-auto px-2">
        <div className="menu grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 mt-4 gap-5">
          <a
            href={`#`}
            className="py-4 px-4 shadow-[0_0_10px_rgba(0,0,0,0.25)] rounded-[10px] text-center"
          >
          ...
          <a
            href={`/${schoolid}?usercode=${userDetails?.User.UserCode}`}
            target="_blank"
            className="py-4 px-4 shadow-[0_0_10px_rgba(0,0,0,0.25)] rounded-[10px] text-center"
          >
          ...
          >
            <div className="text-white py-2 px-3 bg-rose-600 inline-block rounded-[10px]">
              <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-align-box-left-stretch"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 5a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-14z" /><path d="M9 17h-2" /><path d="M13 12h-6" /><path d="M11 7h-4" /></svg>
            </div>
            <h4 className="font-bold text-[18px]">
              হোমওয়ার্ক / বাড়ির কাজ
            </h4>
