...
import { useGetWebSettingsQuery, usePostWebsitesettingsMutation } from '../../features/settings/settingsQuerySlice';
                ...
                <form onSubmit={methods.handleSubmit(onSubmit)}>
                    ...
                    {fields.map((field, index) => (
                        <div key={field.id} className="flex gap-2 items-center mb-2">
                            <DefaultInput defaultValue={field.text} registerKey={`whyUsList.${index}.text`} placeholder={`Point ${index + 1}`} />
                            {fields.length > 1 && (
                                <button
                                    type="button"
