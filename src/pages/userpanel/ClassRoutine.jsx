...
import { useGetClassRoutinesQuery } from '../../features/userPanel/userInfo/userInfoQuerySlice';
...
const ClassRoutine = () => {
  ...
  const { data } = useGetClassRoutinesQuery();
  ...
  const [routineData, setRoutineData] = useState({
    ...
    Friday: {
      'Fajr - 6:00 AM': {
        subject: 'Jumuah Preparation',
        teacher: 'All Teachers',
        class: 'All',
      },
      '8:00 - 9:30 AM': {
        subject: 'Jumuah Lecture',
      ...
      '11:00 - 12:30 PM': {
        subject: 'Jumuah Prayer',
        teacher: '',
        class: 'All',
      },
      'Zohr - 1:30 PM': { subject: 'Prayer Break', teacher: '', class: 'All' },
      '3:00 - 4:30 PM': {
        subject: 'Quran Circle',
        teacher: 'All Teachers',
        class: 'All',
      },
      'Asr - 4:30 PM': { subject: 'Prayer Break', teacher: '', class: 'All' },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-amber-800 mb-4 md:mb-0">
              Class Routine
            </h2>
                    ...
                    {days.map((day) => {
                      ...
                      return (
                        <td key={`${day}-${time}`} className="px-6 py-4">
                          {classInfo.subject === 'Prayer Break' ||
                          classInfo.subject === 'Free Time' ? (
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div className="bg-gradient-to-r from-green-700 to-green-900 px-8 py-6">
              ...
              <p className="text-green-100">
                Full day schedule for {activeDay}
              </p>
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {timeSlots.map((time) => {
                  ...
                  const isPrayerBreak =
                    classInfo.subject.includes('Prayer') ||
                    classInfo.subject.includes('Break');
                  const isSpecial =
                    classInfo.subject.includes('Jumuah') ||
                    classInfo.subject.includes('Weekend');
