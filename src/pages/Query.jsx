    ...
    const methods = useForm({
        defaultValues: {
            ...
            fields: [
                ...
                { "TABLE_NAME": "Student_ReportCet", "UNIQUE_ID": "ReportCetID", "COLUMN_tags": "ReportCetName" }, { "TABLE_NAME": "Student_Report_All", "UNIQUE_ID": "ID", "COLUMN_tags": "Remark" }, { "TABLE_NAME": "Student_ReportType", "UNIQUE_ID": "ReportTypID", "COLUMN_tags": "ReportTypeName" }, { "TABLE_NAME": "Student_Rports", "UNIQUE_ID": "SRID", "COLUMN_tags": "Remark" }],
        },
    });
                    ...
                    <FormProvider {...methods}>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-4 gap-[30px] mt-[30px]">
                            ...
                            <div className="d-flex items-center gap-2">
                                <button type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" onClick={() =>
