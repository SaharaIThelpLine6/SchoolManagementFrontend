                    ...
                    <div className="w-full">
                        <div className="relative z-20 bg-transparent">
                            <select
                                ...
                                className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-4 outline-none transition`}
                            >
                        ...
                        {/*Conditionally render fieldset*/}
                        {selectedValue === "" && (
                            <fieldset className="border border-stroke p-4 mt-4 rounded">
                                <legend className="text-body font-semibold px-2">শিক্ষাবর্ষ</legend>
                                <p className="text-body">শিক্ষাবর্ষ  aaaaaaaa</p>
                            </fieldset>
                        )}
                    </div>
