...
const UserImage = ({ pageTitle }) => {
  ...
  const [downloadZip, { isLoading: isZipLoading }] = useLazyDownloadUserImagesZipQuery();
  ...
  const handleDownloadAllPhotos = async () => {
    ...
    Swal.fire({
      title: 'ডাউনলোড হচ্ছে...',
      html: 'ছবিগুলো সংগ্রহ করা হচ্ছে, অনুগ্রহ করে অপেক্ষা করুন...',
    ...
    try {
      // ✅ RTK Query দিয়ে fetch
      const { blob, fileName } = await downloadZip().unwrap();
      ...
      Swal.fire({
        icon: 'success',
        title: 'সফল!',
        text: 'ছবিগুলো সফলভাবে ডাউনলোড হয়েছে।',
        timer: 2000,
