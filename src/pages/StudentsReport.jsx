...
import DistrictBasedAdmissionRegister from '../view/students/reports/DistrictBasedAdmissionRegister';
import ThanaBasedAdmissionRegister from '../view/students/reports/ThanaBasedAdmissionRegister';
...
const StudentsReport = () => {
  ...
  useEffect(() => {
    ...
    const reportId = [
      2, 4, 5, 8, 9, 12, 14, 15, 16, 17, 18, 19, 21, 22, 24, 26,
      // coming soon
      7, 10, 11, 20, 23,
    ];

    // 🟢 params-এ সব ডাটা যুক্ত করা হলো যেন ব্যাকএন্ড ফিল্টার করতে পারে
    const params = {
    ...
    // Clean up undefined, empty strings, null, and NaN values
  ...
  const studentReportData = [
    ...
    { id: '27', value: '২৭. জেলা ভিওিক ভর্তি রেজিস্টার' },
    { id: '28', value: '২৮. থানা ভিওিক ভর্তি রেজিস্টার' },
  ];

  const reportFieldMap = {
    SessionID: [
      '1', '2', '3', '4', '5', '8', '9', '10', '11', '12', '13', '14', '16', '17', '18', '19', '20', '21', '22', '23', '24', '26', '27', '28',
    ],
    ClassID: [
      '1', '2', '4', '5', '6', '7', '8', '9', '10', '11', '14', '18', '19', '21', '22', '23', '24', '26', '27', '28',
    ],
    gender: ['1', '4', '8', '12', '23', '26', '16'],
    id: ['1', '2', '4', '12', '17', '16', '18', '21'], // New/Old
    RDID: ['1', '5', '8', '9', '12', '23', '26'],
    IsActive: [
      '1', '2', '3', '4', '5', '7', '8', '12', '15', '17', '18', '19', '20', '21', '22', '23',
    ],
    bookOfSubject: ['9', '11'],
    ...
    IdAdmissionForm: ['24'],
    addresss: ['25','27','28'],
    addressDivisionDistrict: ['25', '27', '28'],
    addressThana: ['25', '28'], 
  };
  ...
  const onSubmit = () => {
    const reportComponents = {
      ...
      27: <DistrictBasedAdmissionRegister reportData={reportData} />,
      28: <ThanaBasedAdmissionRegister reportData={reportData} />,
    };
        ...
        <FormProvider {...methods}>
          <form className="w-full space-y-4" onSubmit={handleSubmit(onSubmit)}>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 my-3">
              ...
              {/* Division এবং District সবসময় একসাথে */}
              {reportFieldMap.addressDivisionDistrict.includes(selectedReportID) && (
                <>
                  <DefaultSelect
              ...
              {/* Thana শুধুমাত্র ২৫ এবং ২৮ এ */}
              {reportFieldMap.addressThana.includes(selectedReportID) && (
                <DefaultSelect
...
//     // 🟢 FIX: Clean up undefined, empty strings, null, and NaN values
//     const cleanedParams = Object.fromEntries(
//       Object.entries(params).filter(
//         ([, value]) => 
//           value !== undefined && 
...
//     // Only set params if report_id is present
//     if (cleanedParams.report_id) {
//       setQueryParams(cleanedParams);
//     }
//   }, [
...
//   // Division Change হলে District এবং Thana Reset করা
//   useEffect(() => {
//     if (DivisionID) {
//       setValue('DistrictID', '');
//       setValue('permanentPoliceStationID', '');
...
//   // District Change হলে Thana Reset করা
//   useEffect(() => {
//     if (DistrictID) {
//       setValue('permanentPoliceStationID', '');
//     }
