        ...
        <div className="pt-[80px] lg:pt-5 pb-[80px] hidden_in_print w-full min-h-screen bg-[#f9f9f9]">
            ...
            <div className=" bg-white font-default relative w-[1000px] max-w-full mx-auto pr-[0px]">
                <div className="lg:mb-4 lg:text-end">
                    <button className="print absolute lg:relative top-4 right-2 inline-flex items-center px-4 py-1 gap-2  bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-[4px] font-default" onClick={handlePrint}>
