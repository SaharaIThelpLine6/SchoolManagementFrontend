...
const TableOne = () => {
  ...
  const existingImageUrl = "https://media.istockphoto.com/id/1198442718/vector/avatar-profile-picture-icon-logo-design-vector-illustration.jpg?s=1024x1024&w=is&k=20&c=ohMJTh6CpNT6F2jLcPwXiMbYe20v8Fu54UCvIzcAt7U="
            ...
            <tbody>
              {brandData.length > 0 ? (
                brandData.map((brand, key) => {
                  ...
                  // ✅ real DB image থাকলে data URL, নাহলে null
                  let imageSrc = null;

                  if (
                    imageBuffer?.type === "Buffer" &&
                    Array.isArray(imageBuffer?.data) &&
                    imageBuffer.data.length > 0
                  ) {
                  ...
                  return (
                    ...
                    >
                      <td className="py-1 px-4 border border-white text-start">
                        <ViewPermission
                        ...
                        {brand?.UserType?.ID === 1 && (
                          <button
                            ...
                            onClick={() =>
                              handleStudentAdmissionModel(brand.UserID)
                            }
                          >
                      ...
                      <td className="py-1 px-4 border border-white text-center">
                        ...
                        >
                          <RoundedCropImageUpload
                            ...
                            size="w-16 h-16"
                            userId={brand.UserID}                              // ✅ new
                            onUploadSuccess={() => refetch()}                  // ✅ optional, refetch করতে
                          />
                        </ViewPermission>
                      </td>
