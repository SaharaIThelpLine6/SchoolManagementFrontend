...
const FilterDropdown = () => {
  ...
  return (
    <div className="relative flex">
      <button
        className="flex items-center justify-center gap-[8px] inline-block border border-[#e9edf4] rounded-lg py-2 px-3 text-[14px] font-medium font-kalpurush"
        ref={trigger}
      ...
      >
        ...
        <span className="pt-1">{translate("Filter")}</span>
      ...
      <div
        ...
        className={`absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke bg-white p-1.5 shadow-default ${dropdownOpen === true ? 'block' : 'hidden'
          }`}
      >
