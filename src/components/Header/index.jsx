...
const Header = () => {
  ...
  return (
    <header className="w-full bg-white hidden_in_print">
      ...
      <div className="flex w-full gap-[0px] md:gap-2  md:gap-20 items-center px-2 py-4 md:px-6 2xl:px-11">
        ...
        <div className="flex-grow w-full md:px-0 pl-[26px] md:pl-11">
        ...
        <div className="flex items-center gap-3 md:gap-7">
          {
            userPayInfo ? <p className={`text-white py-[8px] px-[10px] md:px-[20px] rounded-full mb-0 text-nowrap text-[14px] font-semibold ${userPayInfo.RenewDays > 60 ? 'bg-green-500' : userPayInfo.RenewDays > 30 ? 'bg-yellow-500' : 'bg-rose-500'}`}>Days: {userPayInfo.RenewDays}</p> : null
          }
          {
            userPayInfo ? (
              (() => {
                ...
                return (
                  <p className={`text-white py-[8px] px-[10px] md:px-[20px] rounded-full mb-0 text-nowrap text-[14px] font-semibold 
