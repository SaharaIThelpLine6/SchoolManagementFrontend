    ...
    return (
        <div className="w-full">
            ...
            <input
                ...
                className={`w-full rounded border-[1.5px] border-stroke bg-[#EDEDED] px-2 h-[38px] text-black outline-none text-[14px] transition focus:border-primary active:border-primary disabled:cursor-not-allowed disabled:bg-slate-200 ${errors[registerKey] ? 'placeholder:text-red-400 border-red-400': ''}`}
