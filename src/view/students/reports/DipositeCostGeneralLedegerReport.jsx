...
const DipositeCostGeneralLedegerReport = ({ reportData, query }) => {
          ...
          <tbody>
            {reportData.map((item, index) => (
              <tr key={item.FundID} className="text-black text-sm">
                ...
                <td className="border border-black p-2 text-[18px]">{item.TransactionDateEng}</td>
                <td className="border border-black p-2 text-[18px]">{item.VoucherNo}</td>
                <td className="border border-black p-2 text-[18px]">{item.SlName}</td>
                <td className="border border-black p-2 text-[18px]">{item.Particulars}</td>
...
export default DipositeCostGeneralLedegerReport;