...
const BanglaWithOutNameColumn = ({reportData, queryParams}) => {
            ...
            <tbody>
              {reportData && reportData.map((row, i) => (
                <tr key={i} data-idx={i}>
                  ...
                  <td style={{ padding: "5px 6px" }}>{bnBijoy2Unicode(String(row?.User.UserCode))}</td>
...
export default BanglaWithOutNameColumn;
