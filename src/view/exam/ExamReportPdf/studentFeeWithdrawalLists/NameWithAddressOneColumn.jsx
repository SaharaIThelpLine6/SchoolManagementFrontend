const NameWithAddressOneColumn = () => {
  const data = [
    {
      sl: 1,
      roll: '100004',
        ...
        <table className="w-full border-collapse text-xs">
          <thead>
            <tr className="bg-gray-100 text-center font-semibold">
              <th className="border border-gray-300 px-1 py-1 w-8">الترتيب</th>
              <th className="border border-gray-300 px-1 py-1 w-8">رقم</th>
              <th className="border border-gray-300 px-1 py-1 w-12">
                رقم الهوية
              </th>
              <th className="border border-gray-300 px-1 py-1">
                أسماء الطلاب مع العنوان
              </th>
              <th className="border border-gray-300 px-1 py-1">
                أسماء الوالد
              </th>
              <th className="border border-gray-300 px-1 py-1 w-10">الرسوم</th>
            </tr>
          </thead>
          <tbody>
...
export default NameWithAddressOneColumn;
