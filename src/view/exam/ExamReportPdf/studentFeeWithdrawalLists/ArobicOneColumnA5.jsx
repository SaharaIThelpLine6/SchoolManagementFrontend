        ...
        <table className="w-full border-collapse text-xs">
          <thead>
            <tr className="bg-gray-100 text-center font-semibold">
              <th className="border border-gray-300 px-2 py-1 w-10">الترتيب</th>
              <th className="border border-gray-300 px-2 py-1 w-16">
                رقم الهوية
              </th>
              <th className="border border-gray-300 px-2 py-1">اسم الطالب</th>
              <th className="border border-gray-300 px-2 py-1 w-14">الرسوم</th>
            </tr>
          </thead>
          <tbody>
            {data.map((row, i) => (
              ...
              >
                ...
                <td className="border border-gray-300 px-2 py-1 text-end pr-2">
                  {row.name}
                </td>
...
export default ArobicOneColumnA5;
