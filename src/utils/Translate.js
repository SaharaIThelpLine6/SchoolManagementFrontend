...
const useTranslate = () => {
  ...
  const englishToBangla = {
    ...
    "Subject": "বিষয়",
    "Prescribed": "বিষয়",
    "Select those to whom you will charge fees.": "যাদের কাছ থেকে আপনি ফি নেবেন তাদের নির্বাচন করুন।",
    "Accept the following student fees.": "নিম্নোক্ত শিক্ষার্থীদের ফ্রী গ্রহণ করুন।",
    "Talent Condition": "মেধা কন্ডিশন",
    "All the divisions whose merit will be mentioned": "যে সকল বিভাগের যোগ্যতা উল্লেখ করা হবে।",
