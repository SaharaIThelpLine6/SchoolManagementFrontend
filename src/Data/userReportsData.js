...
export const examReports = [
  {
    ReportID: 1,
    ReportName: '1. পরীক্ষার ফি উত্তোলন তালিকা',
  },
  {
    ReportID: 2,
    ReportName: '2. প্রবেশ পত্র',
  },
  {
    ReportID: 3,
    ReportName: '3. দস্তখত পত্র',
  },
  {
    ReportID: 4,
    ReportName: '4. নম্বর পত্র',
  },
  {
    ReportID: 5,
    ReportName: '5. সিট নং',
...
export const examVacationStatus = [
  { id: 1, name: 'পরীক্ষার রুটিন থেকে' },
...
export const examAveragePasNumberStatus = [
  { id: 1, name: "Average Mi'iary" },
  { id: 2, name: "Mi'iary" },
  { id: 3, name: "Higher Mi'iary" },
];
...
export const threeLanguageExamReport = [
  {
    id: 1,
    pdfList: [
      { name: 'one', PdfID: 1 },
...
export const fourLanguageExamReport = [
  {
    id: 1,
    pdfList: [
      { name: 'one', PdfID: 1 },
...
export const sevenLanguageExamReport = [
  {
    id: 1,
    pdfList: [
      { name: 'one', PdfID: 1 },
